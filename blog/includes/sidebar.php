        ...
        <input type="text" name="searchtitle" class="form-control" placeholder="Search for..." required>
          ...
          <div class="card my-4">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-lg-6">
                  <ul class="list-unstyled mb-0" style="color:black !important;">
...
?>
                    ...
                    <li>
                      <a href="category.php?catid=<?php echo htmlentities($row['id'])?>" style="color:black !important;"><?php echo htmlentities($row['CategoryName']);?></a>
                    </li>
<?php } ?>
                  </ul>
                </div>
...
?>
  ...
  <li>
                      <a href="news-details.php?nid=<?php echo htmlentities($row['pid'])?>" style="color:black !important;"><?php echo htmlentities($row['posttitle']);?></a>
                    </li>
            <?php } ?>
          </ul>
            </div>
...
?>
  ...
  <li>
                      <a href="news-details.php?nid=<?php echo htmlentities($result['pid'])?>" style="color:black !important;"><?php echo htmlentities($result['posttitle']);?></a>
                    </li>
            <?php } ?>
          </ul>
            </div>
